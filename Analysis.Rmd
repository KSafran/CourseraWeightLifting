...
The random forest has highest accuracy. We estimate that the out of sample accuracy of this model will be `r sprintf('%.3f', rf.acc)`. We will need to refit on the full training set, then we can make our test predictions.
